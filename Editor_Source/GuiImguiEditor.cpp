...
namespace Gui
{
	...
	void ImguiEditor::OnEvent(DXEngine::Event& e)
	{
		// Block event when ImGui is capturing mouse or keyboard
		if (blockEvent)
		{
			ImGuiIO& io = ImGui::GetIO();
			e.Handled |= e.IsInCategory(DXEngine::EEventCategory::EventCategoryMouse) & io.WantCaptureMouse;
			e.Handled |= e.IsInCategory(DXEngine::EEventCategory::EventCategoryKeyboard) & io.WantCaptureKeyboard;
		}
	}
