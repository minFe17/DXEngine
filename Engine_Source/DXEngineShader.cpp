...
namespace DXEngine::Graphics
{
	...
	Shader::Shader() : Resource(Enum::EResourceType::Shader), rasterizerState(ERasterizerState::SolidNone), blendState(EBlendState::Opaque), depthStencilState(EDepthStencilState::LessEqual)
	{
	}
